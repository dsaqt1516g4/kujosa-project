...
public class Comentari {
    @InjectLinks({
            ...
            @InjectLink(resource = StingResource.class, method = "getSting", style = InjectLink.Style.ABSOLUTE, rel = "self sting", title = "Comentari", bindings = @Binding(name = "id", value = "${instance.id}")),
            ...
            @InjectLink(resource = StingResource.class, method = "getComentaris", style = InjectLink.Style.ABSOLUTE, rel = "next", title = "Newer stings", bindings = {@Binding(name = "timestamp", value = "${instance.creationTimestamp}"), @Binding(name = "before", value = "false")}),
            @InjectLink(resource = StingResource.class, method = "getComentaris", style = InjectLink.Style.ABSOLUTE, rel = "previous", title = "Older stings", bindings = {@Binding(name = "timestamp", value = "${instance.creationTimestamp}"), @Binding(name = "before", value = "true")}),
    })
