...
public interface KujosaMediaType {
    ...
    String KUJOSA_COMMENT = "application/vnd.dsa.kujosa.comment+json";
    String KUJOSA_COMMENT_COLLECTION = "application/vnd.dsa.kujosa.comment.collection+json";
    String KUJOSA_EVENT = "application/vnd.dsa.kujosa.event+json";
    String KUJOSA_EVENT_COLLECTION = "application/vnd.dsa.kujosa.event.collection+json";
}
