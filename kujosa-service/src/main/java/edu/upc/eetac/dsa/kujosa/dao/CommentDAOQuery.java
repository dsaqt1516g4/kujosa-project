...
public class CommentDAOQuery {
    ...
    public final static String INSERT_COMMENT_QUERY = "insert into commentsevent (commentid, userid, eventid, content, image, ratio) values (?, ?, ?, ?, ?, 0)";
